...
void SetLowZZ(int pShift, double pValue) 
{
   datetime now = TimeCurrent( );
	...
	ObjectCreate(StringConcatenate("ZZCR1", now), OBJ_TREND, 0, Time[0], Close[0], Time[10], Close[10]);
	ObjectSet(StringConcatenate("ZZCR1", now), OBJPROP_COLOR, Aqua);
	ObjectSet(StringConcatenate("ZZCR1", now), OBJPROP_WIDTH, 2);
	ObjectSet(StringConcatenate("ZZCR1", now), OBJPROP_STYLE, STYLE_DOT);
	ObjectSet(StringConcatenate("ZZCR1", now), OBJPROP_BACK, false);
	ObjectSet(StringConcatenate("ZZCR1", now), OBJPROP_RAY, true);
	
	ObjectSet(StringConcatenate("ZZCR1", now), OBJPROP_TIME1, Time[b2]);
	ObjectSet(StringConcatenate("ZZCR1", now), OBJPROP_PRICE1, High[b2]);
	ObjectSet(StringConcatenate("ZZCR1", now), OBJPROP_TIME2, Time[b1]);
	ObjectSet(StringConcatenate("ZZCR1", now), OBJPROP_PRICE2, High[b1]);
}
//=================================================================================================
void SetHighZZ(int pShift, double pValue) 
{
   datetime now = TimeCurrent( );
	...
	ObjectCreate(StringConcatenate("ZZCR2", now), OBJ_TREND, 0, Time[0], Close[0], Time[10], Close[10]);
	ObjectSet(StringConcatenate("ZZCR2", now), OBJPROP_COLOR, Khaki);
	ObjectSet(StringConcatenate("ZZCR2", now), OBJPROP_WIDTH, 2);
	ObjectSet(StringConcatenate("ZZCR2", now), OBJPROP_STYLE, STYLE_DOT);
	ObjectSet(StringConcatenate("ZZCR2", now), OBJPROP_BACK, false);
	ObjectSet(StringConcatenate("ZZCR2", now), OBJPROP_RAY, true);

	ObjectSet(StringConcatenate("ZZCR2", now), OBJPROP_TIME1, Time[b2]);
	ObjectSet(StringConcatenate("ZZCR2", now), OBJPROP_PRICE1, Low[b2]);
	ObjectSet(StringConcatenate("ZZCR2", now), OBJPROP_TIME2, Time[b1]);
	ObjectSet(StringConcatenate("ZZCR2", now), OBJPROP_PRICE2, Low[b1]);
}
