...
//   int      _TRADING_HOURS[]  = {3,7,};
   ...
   static double  MACDDiffSmoothed;
   static double  MACDOsc;
   static double  MACDHistogram2;
   static double  MACDSignal2;
   static double  MACDDiff2;
   static double  MACDDiffSmoothed2;
   static double  MACDOsc2;
...
//Do not forget to setup variables evaluated here as a static, to remember last state, if not counted twice for a tick
   if(TickCounted != Tick)
   {
      ...
      MACDHistogram = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 0, 1);
      MACDSignal = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 1, 1);
      MACDDiff = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 2, 1);
      MACDDiffSmoothed = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 3, 1);
      MACDOsc = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 4, 1);
      MACDHistogram2 = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 0, 2);
      MACDSignal2 = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 1, 2);
      MACDDiff2 = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 2, 2);
      MACDDiffSmoothed2 = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 3, 2);
      MACDOsc2 = iCustom(_SYMBOL, _TIMEFRAME, "MACD_RR2", 12,26,9,5, 4, 2);
...
//         break;
         ...
         if(MACDDiffSmoothed < 0)
         if(MACDDiffSmoothed < MACDOsc)
         if(MathAbs(MACDDiffSmoothed - MACDOsc) < MathAbs(MACDDiffSmoothed2 - MACDOsc2))
            result = 1;
