...
//---- основной цикл       
   for(int i = limit; i>0; i--)
     {   
       ...
       ExtMapBuffer1[i] = iCustom(Symbol(), NULL, "ZIGZAG", 1, i);
       //Если он есть, то заносим его в массив фракталов
       buf = iCustom(Symbol(), NULL, "ZIGZAG", 1, i);
       if(buf != 0)
         {
           Up++;
           bufUpPrice[Up] = iCustom(Symbol(), NULL, "ZIGZAG", 1, i);
           bufUpDate[Up] = Time[i];
       ...
       ExtMapBuffer2[i] = iCustom(Symbol(), NULL, "ZIGZAG", 2, i);
       buf = iCustom(Symbol(), NULL, "ZIGZAG", 2, i);    
       if(buf != 0)
         {
           Down++;
           bufDownPrice[Down] = iCustom(Symbol(), NULL, "ZIGZAG", 2, i);
