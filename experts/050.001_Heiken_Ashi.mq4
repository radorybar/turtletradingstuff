...
//   int      _TRADING_HOURS[]  = {3,7,};
   ...
   static double  HeikenAshiWhite;
   static double  HeikenAshiRed;
...
//Do not forget to setup variables evaluated here as a static, to remember last state, if not counted twice for a tick
   if(TickCounted != Tick)
   {
      ...
      HeikenAshiRed = iCustom(_SYMBOL, _TIMEFRAME, "Heiken Ashi Real", 2, 1);
      HeikenAshiWhite = iCustom(_SYMBOL, _TIMEFRAME, "Heiken Ashi Real", 3, 1);
...
//         break;
         ...
         if(HeikenAshiRed < HeikenAshiWhite)
            result = 1;
